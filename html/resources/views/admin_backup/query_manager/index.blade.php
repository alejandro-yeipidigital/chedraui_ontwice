                    ...
                    <div class="card card-border-color card-border-color-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4" style="border-style: solid; border-color: #b8b8b8; border-radius: 10px; box-shadow: 2px 2px 10px #ccc" align="center">
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-sm-12">
                                            <p class="text-right">
                                                ...
                                                <button class="btn btn-space btn-warning md-trigger" data-modal="full-warning" id="almacena_consulta" type="button">Almacenar Consulta</button>
...
{{--     <div class="modal fade show" id="mod-success" tabindex="-1" role="dialog">
                    ...
                    <div class="text-center"></span>
                        ...
                        <form id="store_new_query" method="post" action="">
                            ...
                            <div class="mt-8">
                                ...
                                <textarea name="query" id="new_query" cols="95" rows="5" placeholder="Query"></textarea>
                            </div>
                            
                            <div class="mt-8">
                                <button class="btn btn-secondary btn-space modal-close" type="button" data-dismiss="modal" id="cancel_store">Cancel</button>
                                <button class="btn btn-success btn-space modal-close" type="button" data-dismiss="modal" id="store_query">Almacenar</button>
                            </div>    
                        </form>
                    </div>
                </div>
    ...
    <br><br>
    <div class="container modal-full-color modal-full-color-warning modal-effect-8" id="full-warning" style="perspective: 1300px;">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="text-center"><span class="modal-main-icon mdi mdi-playlist-plus"></span>
                  ...
                  <form id="store_new_query" method="post" action="">
                      ...
                      <div class="mt-8">
                          <button class="btn btn-success btn-space modal-close" type="button" data-dismiss="modal" id="cancel_store">Cancel</button>
...
@section('js')
    ...
    <script>
        ...
        $( document ).ready(function() {
            // Clear inputs before closing modal
            $("#cancel_store").on("click", function(){
                $("#title").val('');
                $("#description").val('');
                $("#new_query").val('');
            ...
            // Open modal
            $("#almacena_consulta").on('click', function(){
                let query =  $("#query").val();
                $("#new_query").val(query);
            });
